...
<section class="informasi-kegiatan">
    <div class="informasi-kegiatan-cards">
        ...
        <div class="informasi-kegiatan-card">
            <a href="{{ route('detail-kegiatan', $item->slug) }}" class="informasi-kegiatan-card-image" style="position: relative;">
                <img src="{{ asset('storage/' . $item->gambar) }}" alt="{{ $item->judul }}">
                <div style="position: absolute; top: 0.75rem; right: 0.75rem; display: flex; gap: 0.5rem;">
                    <span style="background: #0a2540; color: white; padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.75rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
                        {{ $item->bidang_name }}
                    </span>
                    @if($item->is_populer)
                    <span style="background: #ffd700; color: #0a2540; padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.75rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
                        Populer
                    </span>
                    @endif
                </div>
